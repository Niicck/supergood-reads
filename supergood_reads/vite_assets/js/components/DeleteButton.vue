            ...
            >
              ...
              <div class="mt-5 sm:mt-4 sm:flex sm:flex-row-reverse">
                <form method="post" :action="props.deleteUrl">
                  ...
                  <button
                    type="submit"
                    class="inline-flex justify-center rounded-md bg-red-600 py-2 px-3 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 sm:ml-3 sm:w-auto"
                  >
                    Delete
                  </button>
                </form>
